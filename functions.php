...
function featuredlite_edit_porfolio($wp_customize){
//portfolio img
$wp_customize -> add_section('featuredlite_portfolio', array(
        'title' => 'Portfolio'
    ));
$wp_customize -> add_setting('featuredlite_portfolio_image');
$wp_customize -> add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'featuredlite_portfolio_image_control', array(
        'label' => 'Image',
        'section' => 'featuredlite_portfolio',
        'settings' => 'featuredlite_portfolio_image',
        'width' => 500,
        'height' => 500,
    )));
...
$wp_customize -> add_setting('featuredlite_portfolio_h1');
$wp_customize -> add_control(new WP_Customize_Control($wp_customize, 'featuredlite_portfolio_h1_control', array(
        'label' => 'Headline',
        'section' => 'featuredlite_portfolio',
        'settings' => 'featuredlite_portfolio_h1',
        'default' => 'Skill Set',
)));
}
add_action('customize_register', 'featuredlite_edit_porfolio'); 
?>
